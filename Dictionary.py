...
def add_movie():
    ...
    director = input("Enter the name director: ")
    release_date = input("Enter the release date of the movie (YYYY-MM-DD): ")
    actors = input("Enter the names of the actors in the movie (separated by commas): ")
    ...
    def edit_movie():
        ...
        if title in movie_database:
            ...
            # Update the dictoinary with the new information
            if genre:
            ...
            #Function to view all movie from the database
            def delete_movie():
